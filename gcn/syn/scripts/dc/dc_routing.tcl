...
if {$ROUTING_LAYER_DIRECTION_OFFSET_LIST != ""} {
  foreach direction_offset_pair $ROUTING_LAYER_DIRECTION_OFFSET_LIST {
    ...
    puts "Info : Setting preferred routing direction $direction for layer $layer"
    set_preferred_routing_direction -layers $layer -direction $direction
...
# Can report unused layers for debugging
